...
Reads the canonical source `wlc-utils-io/in/wlc422/wlc422_ps.txt` directly, splits
it into per-book scanner-ready text (applying the genre filter so poetic books
never reach the prose grammar), scans each verse into a token stream
