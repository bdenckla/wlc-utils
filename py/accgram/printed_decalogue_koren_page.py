...
# The Tanakh-wide survey of accents on a maqaf-joined proclitic (issue #76), which is where this
# page's Deuteronomy maqaf difference stops being an isolated oddity and gets a rate and a
# precedent.  Generated by accgram/maqaf_proclitic_accents_page.py.
_MAQAF_PROCLITIC_PAGE = "maqaf-proclitic-accents.html"
    ...
    return (
        ...
        H.para(
            (
                ...
                link("its own page", _MAQAF_PROCLITIC_PAGE),
